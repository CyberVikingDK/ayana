...
const Articles = () => {
  ...
  const articles = [
    { id: 1, title: "Ankara Barosu Dergisi’nde Yayımlanmakta Olan Makaleler", pdf: "/pdfs/ankbaro.pdf", date: "20 Eylül", image: "/pdfs/jpg/ankbaro.jpg" },
    { id: 2, title: "Haber 2", pdf: "/pdfs/document2.pdf", date: "15 Ekim", image: "/pdfs/jpg/ankbaro.jpg" },
    { id: 3, title: "Haber 3", pdf: "/pdfs/document3.pdf", date: "10 Kasım", image: "/pdfs/jpg/ankbaro.jpg" },
    // ...existing code...
  ];
