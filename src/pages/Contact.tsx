...
import CallButton from "../components/CallButton"; // Import the new component
...
const Contact = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const mailtoLink = `mailto:ayana@ayana.av.tr?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Ad: ${name}\nE-posta: ${email}\n\nMesaj:\n${message}`)}`;
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="prose max-w-4xl mx-auto">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-accent hover:bg-accent-light text-white font-bold py-3 px-8 rounded-md transition-colors w-full mb-10"
            >
              Gönder
            </button>
          </form>
